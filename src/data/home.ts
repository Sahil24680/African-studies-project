...
export const homeHero = {
  ...
  intro:
    'Police violence against Black people is a major global issue that affects millions of families and communities. In countries such as the United States, the United Kingdom, and Brazil, Black communities are disproportionately affected by police brutality, racial profiling, and mass incarceration. Even though these countries are different in terms of government and cultures, they all share histories of slavery, colonialism, systemic racism, and racial inequality that still influence policing today. Police violence is not just a criminal justice concern; it is also a public and mental health crisis. Multiple encounters with or exposure to police brutality can lead to trauma within Black communities. In addition, racial trauma developed through exposure to racism and discrimination increases stress levels and can psychologically traumatize Black individuals and their families.',
}
