...
export const policeBrazilContent: CountryPageContent = {
  ...
  systemicPatterns: [
    ...
    {
      title: 'Racial Inequality in Education and Employment',
      description:
        'Racial inequality in Brazil also appears in education, employment, and income levels. Afro-Brazilians are still more likely to live in poverty and less likely to have access to higher education and professional jobs. These inequalities continue to reinforce each other because the same communities that face economic disadvantages are also the ones most affected by police violence and lack of government support.',
    },
  ],
